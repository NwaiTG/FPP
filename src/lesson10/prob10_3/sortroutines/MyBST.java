...
//			printTree(root); (ntg)
	...
	private void printTree(Node t, List<Integer> intArr) {
		if (t != null) {
			printTree(t.left, intArr);
//			System.out.println(t.element);
			intArr.add(t.element);
			printTree(t.right, intArr);
		}
	}
	...
	public int[] readintoArray() {
		...
		printTree(root, tempArr);
		int[] res = new int[tempArr.size()];
