...
import lesson4.lab7.MyStringList;
...
public class Employee implements Comparable<Employee> {
	...
	public int compareTo(Employee e) {
		//implement
		int res = 0;
		Account thisLargestAcct = this.accounts.getLargest();
		Account compareLargestAcct = e.accounts.getLargest();
		return thisLargestAcct.compareTo(compareLargestAcct);
//		if(thisLargestAcct.getBalance() > compareLargestAcct.getBalance()) {
//			res = 1;
//		}
//		return res;
	}
