package lesson3.Assignment5;

import java.util.Scanner;
//package lesson3.Assignment5;

import lesson3.Assignment5.more.StoreDirectory;
import lesson3.Assignment5.more.*;
...
public class Driver {
	...
	void displayNumberOfCDsInBookstore(){
		//implement-- redo the implementation
		int numCDs = directory.getNumCDsInBookstore();
		if(numCDs > -1) {
			System.out.println("Number of CD's is " + numCDs + " (Look for console messages.)"+n+CONTINUE);
		}	
	}
